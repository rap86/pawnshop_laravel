...
<div class="row">
    <div class="col-md-12 cold-lg-12">
		<form action="{{ route('item_interests.store') }}" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
			@csrf
			<div class="card card-secondary card-outline">

				<div class="card-header">
					<span class="text-muted text-lg">Add item Interest</span>
				</div>
				<div class="card-body">
