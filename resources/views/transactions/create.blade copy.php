                        ...
                        <div class="tab-pane active" id="home">
                            <div class="row">
                                <div class="col-md-5 col-lg-7">
                                    <div class="card">
                                        <div class="card-header">
                                            <span class="text-muted">New Transaction </span> <?php echo $books[2]['deduct_first_month'] ?> </h4> 
                                        </div>
                                        <div class="card-body">
                                            <div class="form-group row">
                                                <label class="col-sm-3 col-form-label label-align">Interest by</label>
                                                <div class="col-sm-9">
                                                    <select class="form-control" name="interest_by">
                                        ...
                                        <div class="tab-content" id="myTabContent">
                                            <div class="tab-pane fade show active" id="one" role="tabpanel" aria-labelledby="one-tab">
                                                ...
                                                <div class="card JewelryInput" style="display:none;">
                                                    ...
                                                    <div class="card-body">
                                                        <div class="form-group row">
                                                            <label class="col-sm-5 col-form-label label-align">Jewelry Type</label>
                                                            <div class="col-sm-7">
                                            ...
                                            <div class="tab-pane fade" id="two" role="tabpanel" aria-labelledby="two-tab">
                                                ...
                                                <div class="card NonJewelryInput" style="display:none;">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="form-group row">
                                                            <label class="col-sm-5 col-form-label label-align">Item Type</label>
                                                            <div class="col-sm-7">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="card card-outline">
                                        ...
                                        <div class="card-body box-profile">
                                            <center>
                                                <div class="w3-container w3-center" style="min-height:300px;" id="results"></div>
                                            </center>
                                        </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="card card-outline">
                                        ...
                                        <div class="card-body box-profile">
                                            <center>
                                                <div class="w3-container img-responsive" style="min-height:300px; !important" id="my_camera"></div>
                                            </center>
                                        </div>
                                        <div class="card-footer border">
                                            <div class="w3-section">
                                                <div class="btn btn-secondary btn-block p-2" onClick="take_snapshot()">Take a Photo</div>
                                            </div>	
                                        </div>
                                    </div>
                                </div>
